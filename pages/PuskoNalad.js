      ...
      <div className="mycontainer section-plate">
        <div className="row m-0">
          <div className="col-12 pt-2 pb-4">
            ...
            <div className="razdel-list">
              <div className="razdel-li">
                ...
                <ul className="razdel-list-ul">
                  ...
                  <li className="razdel-ul-li">
                    <p className="text-italic">
                      Проверка подключения напряжения собственных нужд 220/380
                      В.
                    </p>
                  </li>
                  <li className="razdel-ul-li">
            ...
            <h2 className="header-min-colored">2. Система газоснабжения:</h2>
            <div className="razdel-list">
              <div className="razdel-li">
            ...
            <h2 className="header-min-colored">3. Система утилизации тепла </h2>
            <div className="razdel-list">
              <div className="razdel-li">
                <p className="text-big">
              ...
              <div className="razdel-li">
                <p className="text-big">3.4. Настройка аварийных установок</p>
              </div>
              <div className="razdel-li">
                <p className="text-big">
            ...
            <h2 className="header-min-colored">5. Система управления КГПУ:</h2>
            <div className="razdel-list">
              <div className="razdel-li">
                <p className="text-big">5.1. Проверка работы контроллеров.</p>
              </div>
              <div className="razdel-li">
                <p className="text-big">
