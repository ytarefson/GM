...
const Products = data => (
  <div>
    <NextHead>
      <title>
        Автономные газопоршневыевые электростанции и мини-тэц. Каталог продукции
        ООО "Газовые машины"
      </title>
      <meta
        name="description"
              ...
              <div className="promo-text-container">
                ...
                <div className="text-min-container">
                  <p className="text-min">
                    ...
                    газопоршневых электростанций уже более 12 лет и за это время
                    протестировали большое количество комплектующих и схем
                    сборки, и смогли найти лучшие решения при минимуме затрат.
                  </p>
                  <p className="text-min">
                    Силовые установки, использующиеся при проектировании газовых
                    электростанций, прошли многолетнюю проверку в рабочих
