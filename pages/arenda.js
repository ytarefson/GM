              ...
              <div className="arenda-promo">
                <div className="arenda-top">
                  ...
                  <p className="text">
                    ...
                    исполнении мощностью от 0,1 до 2&nbsp;мВт на выгодных
                    условиях.
                  </p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-lg-8 pr-xl-5">
              ...
              <div className="text">
                В рамках поддержки производственных предприятий по Центральному
                и Северо-западному федеральному округу, создан новый формат
                взаимодействия на базе предоставления льготного лизинга
                энергетического оборудования.
              </div>
              <p className="text">
                АО «Региональная лизинговая компания Ярославской области»
                предлагает Вам воспользоваться программой льготного лизинга на
                приобретение нового оборудования для субъектов индивидуального и
              ...
              <p className="text-min">
                С более детальной информацией о нашей компании и предоставляемых
                услугах Вы можете ознакомиться в ООО «Газовые машины», либо
                позвонить по телефону: 8&nbsp;(4852)&nbsp;58-80-84.
              </p>
            </div>
