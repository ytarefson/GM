      ...
      <div className="col-12">
        <div className="container">
          ...
          <p className="text-common">
            “Газовые машины” предлагает широкий спектр высокоэффективных систем
            с низкой эмиссией когенерации. Наши системы ТЭЦ обеспечивают десятки
            разнообразных предприятий по всей России.
          </p>
          <br />
          <p className="text-common">
